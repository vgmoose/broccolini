...
void TabSwitcher::createTabCards() {
    ...
    for (auto tab : curTabs) {
        ...
        if (tab == NULL) {
            ...
            newTabCard->setAction([this, mainDisplay, urlBar, cardImgPath, newCardImage]() {
        ...
        if (tabPath == currentTabPath) {
            ...
            activeTabOverlay->animate(200, [
                startX, startY, this, currentCon, card, thumbnail,
                startWidth, startHeight, activeTabOverlay
            ](float progress) {
    ...
    closeButton = createThemedIcon("x")
        ...
        ->setAction([this, mainDisplay, currentTabPath, lastActiveThumbnail]() {
    ...
    urlBar->animate(200, [urlBar](float progress) {
...
void TabSwitcher::close(std::string imgPath, Element* thumbnail) {
    ...
    overlay->animate(200, [overlay, thumbnail, urlBar, this](float progress) {
...
void TabSwitcher::render(Element* parent) {
    ...
    // draw the url bar at the very end, from under the subscreen, which will animate out
